  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <Link to="/categories/new" className="btn bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
          Add Category
        </Link>
      </div>
            ...
            {loading ? (
              ...
              categories.map((category) => (
                <tr key={category.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{category.cat_description}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <Link className="text-indigo-600 hover:text-indigo-900 mr-2" to={'/categories/' + category.id}>
                      Edit
                    </Link>
